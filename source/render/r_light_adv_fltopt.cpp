...
static VCvarB r_shadowvol_optimise_flats("r_shadowvol_optimise_flats", false, "Drop some floors/ceilings that can't possibly cast shadow?", CVAR_Archive|CVAR_NoShadow);
#ifdef VV_CHECK_1S_CAST_SHADOW
static VCvarB r_shadowvol_optimise_lines_1s("r_shadowvol_optimise_lines_1s", true, "Drop some 1s walls that can't possibly cast shadow? (glitchy)", CVAR_NoShadow);
#endif
