...
protected:
  ...
  // surf methods
  virtual void InitSurfs (bool recalcStaticLightmaps, surface_t *ASurfs, texinfo_t *texinfo, const TPlane *plane, subsector_t *sub, seg_t *seg) override;
  ...
  bool CastStaticRay (float *dist, subsector_t *srcsubsector, const TVec &p1, const TVec &p2, float squaredist);
