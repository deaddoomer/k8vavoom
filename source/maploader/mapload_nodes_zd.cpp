...
static void CopyNodeZD (int NodeIndex, const ZDBSP::MapNodeEx &SrcNode, node_t *Node) {
  ...
  Node->bbox2d[0][BOX2D_MINX] = SrcNode.bbox[0][ZDBSP::BOXLEFT]; // minx
  Node->bbox2d[0][BOX2D_MINY] = SrcNode.bbox[0][ZDBSP::BOXBOTTOM]; // miny
  Node->bbox2d[0][BOX2D_MAXX] = SrcNode.bbox[0][ZDBSP::BOXRIGHT]; // maxx
  Node->bbox2d[0][BOX2D_MAXY] = SrcNode.bbox[0][ZDBSP::BOXTOP]; // maxy

  Node->bbox2d[1][BOX2D_MINX] = SrcNode.bbox[1][ZDBSP::BOXLEFT]; // minx
  Node->bbox2d[1][BOX2D_MINY] = SrcNode.bbox[1][ZDBSP::BOXBOTTOM]; // miny
  Node->bbox2d[1][BOX2D_MAXX] = SrcNode.bbox[1][ZDBSP::BOXRIGHT]; // maxx
  Node->bbox2d[1][BOX2D_MAXY] = SrcNode.bbox[1][ZDBSP::BOXTOP]; // maxy
