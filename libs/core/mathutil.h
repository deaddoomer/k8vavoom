...
static VVA_OKUNUSED VVA_CONST VVA_CHECKRESULT VVA_ALWAYS_INLINE float ByteToAngle (vuint8 angle) noexcept { return (float)(angle*360.0f/256.0f); }
static VVA_OKUNUSED VVA_PURE VVA_CHECKRESULT VVA_ALWAYS_INLINE vuint8 AngleToByte (const float angle) noexcept { return (vuint8)(AngleMod(angle)*256.0f/360.0f); }


static VVA_OKUNUSED VVA_CONST VVA_CHECKRESULT
VVA_ALWAYS_INLINE vint32 scaleInt (vint32 a, vint32 b, vint32 c) noexcept { return (vint32)(((vint64)a*b)/c); }

static VVA_OKUNUSED VVA_CONST VVA_CHECKRESULT
VVA_ALWAYS_INLINE vuint32 scaleUInt (vuint32 a, vuint32 b, vuint32 c) noexcept { return (vuint32)(((vuint64)a*b)/c); }


// this is actually branch-less for ints on x86, and even for longs on x86_64
static VVA_OKUNUSED VVA_CONST VVA_CHECKRESULT
VVA_ALWAYS_INLINE vuint8 clampToByte (vint32 n) noexcept {
  n &= -(vint32)(n >= 0);
...
static VVA_OKUNUSED VVA_CONST VVA_CHECKRESULT
VVA_ALWAYS_INLINE vuint8 clampToByteU (vuint32 n) noexcept {
...
static VVA_OKUNUSED VVA_PURE VVA_CHECKRESULT
VVA_ALWAYS_INLINE float neumsum2 (float v0, const float v1) noexcept {
  // one iteration
  const float t = v0+v1;
...
// Neumaier-Kahan algorithm
static VVA_OKUNUSED VVA_PURE VVA_CHECKRESULT
VVA_ALWAYS_INLINE float neumsum3 (float v0, const float v1, const float v2) noexcept {
  // first iteration
  const float t = v0+v1;
...
// Neumaier-Kahan algorithm
static VVA_OKUNUSED VVA_PURE VVA_CHECKRESULT
VVA_ALWAYS_INLINE float neumsum4 (float v0, const float v1, const float v2, const float v3) noexcept {
  // first iteration
  float t = v0+v1;
...
// Neumaier-Kahan algorithm
static VVA_OKUNUSED VVA_PURE VVA_CHECKRESULT
VVA_ALWAYS_INLINE double neumsum2D (double v0, const double v1) noexcept {
  // one iteration
...
// Neumaier-Kahan algorithm
static VVA_OKUNUSED VVA_PURE VVA_CHECKRESULT
VVA_ALWAYS_INLINE double neumsum3D (double v0, const double v1, const double v2) noexcept {
  // first iteration
  const double t = v0+v1;
