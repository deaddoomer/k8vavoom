...
public:
  ...
  VVA_ALWAYS_INLINE bool isZeroSkipRoll () const noexcept { return (pitch == 0.0f && yaw == 0.0f); }
...
VVA_ALWAYS_INLINE VVA_PURE vuint32 GetTypeHash (const TAVec &v) noexcept { return joaatHashBuf(&v, 3*sizeof(float)); }
