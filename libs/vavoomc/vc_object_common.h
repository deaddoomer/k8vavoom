...
#include "vc_object_rtti.h"
  ...
  DECLARE_FUNCTION(PerpDot2D)
  DECLARE_FUNCTION(Project2D)
  DECLARE_FUNCTION(IsPointOnLine2D)
  DECLARE_FUNCTION(IsPointOnSeg2D)
  DECLARE_FUNCTION(IsProjectedPointOnSeg2D)
