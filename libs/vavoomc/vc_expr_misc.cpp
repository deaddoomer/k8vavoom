...
VExpression *VDropResult::DoResolve (VEmitContext &ec) {
  ...
  if (op->Type.Type != TYPE_String && op->Type.GetStackSlotCount() != 1 &&
...
void VDropResult::Emit (VEmitContext &ec) {
  ...
  else if (op->Type.GetStackSlotCount() == 1) ec.AddStatement(OPC_Drop, Loc);
}
...
//==========================================================================
//
//  VGetBuiltInClassProperty::VGetBuiltInClassProperty
//
//==========================================================================
VGetBuiltInClassProperty::VGetBuiltInClassProperty (TGetType AType, VExpression *AObjExpr, const TLocation &ALoc)
  : VExpression(ALoc)
  , M(nullptr)
  , ObjExpr(AObjExpr)
  , ResType(AType)
...
//==========================================================================
//
//  VGetBuiltInClassProperty::SyntaxCopy
//
//==========================================================================
VExpression *VGetBuiltInClassProperty::SyntaxCopy () {
  auto res = new VGetBuiltInClassProperty();
  DoSyntaxCopyTo(res);
  return res;
}
...
//==========================================================================
//
//  VGetBuiltInClassProperty::DoRestSyntaxCopyTo
//
//==========================================================================
void VGetBuiltInClassProperty::DoSyntaxCopyTo (VExpression *e) {
  VExpression::DoSyntaxCopyTo(e);
  auto res = (VGetBuiltInClassProperty *)e;
  res->ObjExpr = (ObjExpr ? ObjExpr->SyntaxCopy() : nullptr);
  res->ResType = ResType;
  res->M = M; // why not?
}
...
//==========================================================================
//
//  VGetBuiltInClassProperty::DoResolve
//
//==========================================================================
VExpression *VGetBuiltInClassProperty::DoResolve (VEmitContext &ec) {
  if (ObjExpr) ObjExpr = ObjExpr->Resolve(ec);
  if (!ObjExpr) {
    delete this;
    return nullptr;
  ...
  switch (ResType) {
    case TGetType::Name: M = VObject::StaticClass()->FindMethodChecked("GetClassName"); break;
    case TGetType::Parent: M = VObject::StaticClass()->FindMethodChecked("GetClassParent"); break;
    case TGetType::Replacement: M = VObject::StaticClass()->FindMethodChecked("GetClassReplacement"); break;
    case TGetType::Replacee: M = VObject::StaticClass()->FindMethodChecked("GetClassReplacee"); break;
    case TGetType::IsNative: M = VObject::StaticClass()->FindMethodChecked("IsNativeClass"); break;
    case TGetType::IsAbstract: M = VObject::StaticClass()->FindMethodChecked("IsAbstractClass"); break;
    case TGetType::FullName: M = VObject::StaticClass()->FindMethodChecked("GetFullClassName"); break;
    case TGetType::Location: M = VObject::StaticClass()->FindMethodChecked("GetClassLocationStr"); break;
  }
  vassert(M);

  if (!M->IsStatic() || !M->IsFinal()) {
    ParseError(Loc, "method `%s` should be static final", *M->Name);
    //delete this;
    //return nullptr;
  }
  ...
  switch (ResType) {
    case TGetType::Name:
      Type = VFieldType(TYPE_Name);
      break;
    case TGetType::Parent:
    case TGetType::Replacement:
    case TGetType::Replacee:
      Type = VFieldType(TYPE_Class);
      Type.Class = VObject::StaticClass(); // we don't know the real class type
      break;
    case TGetType::IsNative:
    case TGetType::IsAbstract:
      Type = VFieldType(TYPE_Int); // bool
      break;
    case TGetType::FullName:
    case TGetType::Location:
...
//==========================================================================
//
//  VGetBuiltInClassProperty::Emit
//
//==========================================================================
void VGetBuiltInClassProperty::Emit (VEmitContext &ec) {
  vassert(ObjExpr);
  vassert(M);

  ObjExpr->Emit(ec);
  ec.AddStatement(OPC_Call, M, 1/*SelfOffset*/, Loc);
}


//==========================================================================
//
//  VGetBuiltInClassProperty::toString
//
//==========================================================================
VStr VGetBuiltInClassProperty::toString () const {
  VStr res = VExpression::e2s(ObjExpr);
  switch (ResType) {
    case TGetType::Name: res += ".Name"; break;
    case TGetType::Parent: res += ".Parent"; break;
    case TGetType::Replacement: res += ".Replacement"; break;
    case TGetType::Replacee: res += ".Replacee"; break;
    case TGetType::IsNative: res += ".IsNative"; break;
    case TGetType::IsAbstract: res += ".IsAbstract"; break;
    case TGetType::FullName: res += ".FullName"; break;
    case TGetType::Location: res += ".Loc"; break;
  }
  return res;
}
