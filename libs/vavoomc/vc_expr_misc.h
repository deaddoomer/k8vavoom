...
//==========================================================================
//
//  VGetBuiltInClassProperty
//
//  sorry for this frankencode
//
//==========================================================================
class VGetBuiltInClassProperty : public VExpression {
public:
  enum TGetType {
    Name, // GetClassName (name)
    Parent, // GetClassParent (class)
    Replacement, // GetClassReplacement (class)
    Replacee, // GetClassReplacee (class)
    IsNative, // IsNativeClass (bool)
    IsAbstract, // IsAbstractClass (bool)
    FullName, // GetFullClassName (string)
    Location, // GetClassLocationStr (string)
  };

protected:
  VMethod *M; // set in resolver
...
public:
  ...
  // `AObjExpr` should NOT be already resolved
  VGetBuiltInClassProperty (TGetType AType, VExpression *AObjExpr, const TLocation &ALoc);
  virtual ~VGetBuiltInClassProperty () override;
  virtual VExpression *SyntaxCopy () override;
  virtual VExpression *DoResolve (VEmitContext &) override;
  virtual void Emit (VEmitContext &) override;
